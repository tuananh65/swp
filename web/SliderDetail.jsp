...
<% if (request.getAttribute("sliders") == null) {
    request.getRequestDispatcher("/sliderdetail").forward(request, response);
} %>
...
<body>
    <form action="${pageContext.request.contextPath}/sliderdetail" method="get">
    <div class="wrapper">
