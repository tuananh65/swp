    ...
    <body>
            ...
            <div class="nav-container">
                ...
                <div class="nav-menu" id="nav-menu">
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link">Trang chủ <i class="fas fa-chevron-down"></i></a>
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link">Khóa học <i class="fas fa-chevron-down"></i></a>
                        <div class="dropdown-content">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link">Trang <i class="fas fa-chevron-down"></i></a>
                        <div class="dropdown-content">
                            <a href="${pageContext.request.contextPath}/profile?id=<%= user.getUserId() %>">Hồ sơ</a>
        ...
        <footer class="footer">
                    ...
                    <div class="footer-content">
                        <div class="footer-section">
                            ...
                            <p class="footer-description">
                                Nền tảng học trực tuyến giúp bạn phát triển kỹ năng mềm hiệu quả với các khóa học chất lượng cao.
                            </p>
            ...
            <div class="footer-bottom">
                <div class="container">
                    <p>© 2024 <strong>Soft Skills Learning</strong>. Tất cả quyền được bảo lưu.</p>
                </div>
            </div>
        </footer>
