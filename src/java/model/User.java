...
public class User {
    ...
    private String activationToken; // Thêm trường token
    private boolean isActivated;    // Thêm trường trạng thái kích hoạt
    ...
    public User(int userId, String userName, String password, int roleId, String fullName, String gender, 
                ...
                String status, Date createdAt, String activationToken, boolean isActivated) {
        this.userId = userId;
