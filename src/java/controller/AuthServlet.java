...
public class AuthServlet extends HttpServlet {
    ...
    private void register(HttpServletRequest request, HttpServletResponse response)
        ...
        if (registered) {
            sendActivationEmail(request, email, activationToken); // Updated to pass request
    ...
    private void sendActivationEmail(HttpServletRequest request, String recipientEmail, String token) {
        ...
        System.out.println("Generated activation link: " + activationLink); // Debug log
    ...
    private void activateAccount(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println("Activation token: " + token); // Debug log
    ...
    private void sendResetLink(HttpServletRequest request, HttpServletResponse response)
        ...
        if (user == null) {
            ...
            System.out.println("Generated reset link: " + resetLink); // Debug log
